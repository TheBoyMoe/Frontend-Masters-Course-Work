...
// instantiate a project, use the 'new' keyword
// by using this technique, as apposed to a module pattern for Project
// you lose the benefits of ENCAPSULATION, all the methods on the prototype 
...
Project.prototype.addWork = function(workEntryData){
...
Project.prototype.getWorkEntryCount = function(){
	return this.work.length;
}

Project.prototype.getWorkEntryLocation = function(workEntryId){
